...
foxyy_8bit = scale(foxyy_8bit, (160, 196))
bamboo_8bit = scale(bamboo_8bit, (160, 196))
bright_8bit = scale(bright_8bit, (160, 196))
...
def npc_display(control, scene_x, floor_passed):
    if control <= 1 or floor_passed:
        return
    screen.blit(npc_images[control], (1100 + scene_x, 360))
